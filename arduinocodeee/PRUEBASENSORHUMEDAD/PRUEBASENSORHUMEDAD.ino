...
void setup() {
  ...
  digitalWrite(LED_02, HIGH); //--> Tc:\xampp\htdocs\dashboard-php-mysql\TestDatabaseAccessArduino.curn on LED_02.
...
void loop() {
  ...
  c:\xampp\htdocs\dashboard-php-mysql\TestDatabaseAccessArduino.c
